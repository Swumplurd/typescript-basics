(() => {
    ...
    /*Si despues de la declaracion de parametros ponemos : y especificamos un tipo de dato 
    (params:params):string establecemos que la funcion debe retornar ese tipo de dato*/
